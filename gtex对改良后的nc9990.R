...
outcome_gwas <- fread("mydata_nc99.csv",header = T)
setwd("/Users/hou/Desktop/pqtlexp/")
filename <- dir()
...
outcome_gwas <- fread("mydata_nc90.csv",header = T)
setwd("/Users/hou/Desktop/pqtlexp/")
filename <- dir()
pqtl <- gsub(".csv","",filename)
orpath <- "/Users/hou/Desktop/resor/"##注意末尾需要有/
