...
outcome_gwas <- fread("Results_99th_percentile_processed.txt",header = T)
setwd("/Users/hou/Desktop/pqtlzhang-all/")    #pqtlexp      newcispqtl0.01
filename <- dir()
...
outcome_gwas <- fread("Results_90th_percentile_processed.txt",header = T)
setwd("/Users/hou/Desktop/pqtlzhang-all/")    #pqtlexp   newcispqtl0.01
filename <- dir()
pqtl <- gsub(".csv","",filename)
orpath <- "/Users/hou/Desktop/resor/"##注意末尾需要有/
