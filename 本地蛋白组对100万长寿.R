...
outcome_gwas <- fread("longevity.tsv",header = T) %>% as.data.frame()
setwd("/Users/hou/Desktop/gtex1e5_ld0.01/")  #gtex1e5_ld0.01  #cis_decodepqtl    #pqtlexp    #newcispqtl0.01     #pqtlzhang-all
filename <- dir()
